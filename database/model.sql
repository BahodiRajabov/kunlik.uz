...
create table sub_services (
  s_service_id int generated by default as identity not null primary key,
  s_service_name varchar(256) not null,
...
create table workers (
  ...
  s_service_id int references sub_services (s_service_id) not null,
  created_at timestamp with time zone  not null default current_timestamp
);
